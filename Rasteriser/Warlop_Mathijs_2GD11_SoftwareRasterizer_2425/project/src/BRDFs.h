...
namespace dae
{
	namespace BRDF
	{
		...
		{
			// Calculate the diffuse reflectance using the Lambertian model
			//ColorRGB rho = kd * cd; // Scalar multiplication: diffuse coefficient * color
			//ColorRGB color = rho / PI; // Normalize by PI to apply Lambert's Cosine Law
